// Setting up animation with decent data-structures
...
void init(SDL_Surface ** screen)
{
  ...
  *screen = SDL_SetVideoMode(640, 480, 24, SDL_HWSURFACE | SDL_ASYNCBLIT | SDL_DOUBLEBUF | SDL_OPENGL );
...
//glBegin(GL_LINES);
  ...
  //for(k=0;k<20;k++)
  //{
  //  glVertex3f(xx+20*cos(3.1415926*k/10),200+20*sin(3.1415926*k/10),0);
  //  glVertex3f(xx+20*cos(3.1415926*(k+1)/10),200+20*sin(3.1415926*(k+1)/10),0);
  //}
  //glEnd();
